(function () {
...
})()(
	{
		...
		9: [
			...
			{ "./GoTrueApi": 7, "./GoTrueClient": 8, "./lib/types": 15 },
		],
		10: [
			function (require, module, exports) {
				"use strict";
		...
		17: [
			...
			{
				"./lib/PostgrestQueryBuilder": 20,
				"./lib/PostgrestRpcBuilder": 21,
				"./lib/constants": 23,
			},
		],
		18: [
		...
		20: [
			...
			{ "./PostgrestFilterBuilder": 19, "./types": 24 },
		],
		21: [
			function (require, module, exports) {
				"use strict";
		...
		27: [
			...
			{ "./lib/constants": 29, "./lib/push": 30, "./lib/timer": 32 },
		],
		28: [
			function (require, module, exports) {
				"use strict";
		...
		37: [
			...
			{ "./constants": 39, "./fetch": 40, "./helpers": 41 },
		],
		38: [
			function (require, module, exports) {
				"use strict";
		...
		45: [
			...
			{
				"./lib/SupabaseAuthClient": 47,
				"./lib/SupabaseQueryBuilder": 48,
				"./lib/constants": 50,
				"./lib/helpers": 51,
				"@supabase/functions-js": 6,
				"@supabase/postgrest-js": 18,
				"@supabase/realtime-js": 28,
				"@supabase/storage-js": 36,
			},
		],
		46: [
			function (require, module, exports) {
		...
		48: [
			...
			{ "./SupabaseRealtimeClient": 49, "@supabase/postgrest-js": 18 },
		],
		49: [
			function (require, module, exports) {
				"use strict";
		...
		54: [
			...
			{
				"../cancel/CanceledError": 57,
				"../core/AxiosError": 60,
				"../core/buildFullPath": 62,
				"../defaults/transitional": 68,
				"../helpers/parseProtocol": 80,
				"./../core/settle": 65,
				"./../helpers/buildURL": 71,
				"./../helpers/cookies": 73,
				"./../helpers/isURLSameOrigin": 76,
				"./../helpers/parseHeaders": 79,
				"./../utils": 84,
			},
		],
		55: [
			...
			{
				"../lib/core/AxiosError": 60,
				"./cancel/CancelToken": 56,
				"./cancel/CanceledError": 57,
				"./cancel/isCancel": 58,
				"./core/Axios": 59,
				"./core/mergeConfig": 64,
				...
				"./env/data": 69,
				"./helpers/bind": 70,
				"./helpers/isAxiosError": 75,
				"./helpers/spread": 81,
				"./helpers/toFormData": 82,
				"./utils": 84,
			},
		],
		56: [
		...
		59: [
			...
			{
				"../helpers/buildURL": 71,
				"../helpers/validator": 83,
				"./../utils": 84,
				"./InterceptorManager": 61,
				"./buildFullPath": 62,
				"./dispatchRequest": 63,
				"./mergeConfig": 64,
			},
		...
		62: [
			...
			{ "../helpers/combineURLs": 72, "../helpers/isAbsoluteURL": 74 },
		],
		63: [
			function (require, module, exports) {
				"use strict";
		...
		67: [
			...
			},
			{
				...
				"../adapters/xhr": 54,
				"../core/AxiosError": 60,
				"../helpers/normalizeHeaderName": 77,
				"../helpers/toFormData": 82,
				"../utils": 84,
				"./env/FormData": 78,
				"./transitional": 68,
		...
		83: [
			...
			{ "../core/AxiosError": 60, "../env/data": 69 },
		],
		84: [
			function (require, module, exports) {
				"use strict";
		...
		90: [
			function (require, module, exports) {
				...
				async function twitchAuth() {
					...
					const authUrl =
						...
						`&client_id=${encodeURIComponent(
							"yk62ix6gpuplw5acj37vh5l06zjobw"
						)}` +
				...
				async function sendTwitchCode() {
					...
					if (typeof window !== "undefined") {
						...
						var code = url.searchParams.get("code");
						await axios.post(
							"https://server-e4bkq5wbca-uc.a.run.app/twitchProfile",
							{
								code: `${code}`,
								responseId: `${userresponseId}`,
							}
				...
				async function sendTwitchCodeDashboard() {
					...
					if (typeof window !== "undefined") {
						...
						var code = url.searchParams.get("code");
						await axios.post(
							"https://server-e4bkq5wbca-uc.a.run.app/twitchDashboard",
							{
								code: `${code}`,
								responseId: `${userresponseId}`,
							}
				...
				window.onload = function () {
					...
					if (
						...
						window.location.href.indexOf("c3ab8aa609ea11e793ae92361f002671") >
							-1
					) {
						sendCode();
						window.location.href =
			...
			{ "@supabase/supabase-js": 46, axios: 53 },
		],
	},
	{},
	[90]
